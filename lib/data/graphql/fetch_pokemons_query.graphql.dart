...
class FetchPokemons$Query$Pokemon extends JsonSerializable with EquatableMixin {
  ...
  List<Object?> get props =>
      [id, name, number, image, classification, types, maxCP, maxHP];
  @override
...
final FETCH_POKEMONS_QUERY_DOCUMENT_OPERATION_NAME = 'fetch_pokemons';
...
class FetchPokemonsQuery
  ...
  @override
  final String operationName = FETCH_POKEMONS_QUERY_DOCUMENT_OPERATION_NAME;
